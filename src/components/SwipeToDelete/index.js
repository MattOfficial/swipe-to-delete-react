...
//   let device;
//   const regionContent = useRef(null);
//   let addHandlers,
//     isInteract,
//     interact,
//     onMove,
...
//   const model = new Model({ deleteSwipe: props.deleteSwipe });

//   const moveAt = (e) => {
//     const target = regionContent.firstChild;
//     const res = device.getPageX(e) - model.startX;

//     target.style.left = `${res}px`;
//   };

//   const callMoveCB = (e) => {
//     const x = device.getPageX(e);
//     const prev = model.prevX || model.startX;
...
//     shift > 0 ? props.onRight(e) : props.onLeft(e);

//     model.prevX = x;
//   };

//   const stopListenEndInteract = (el) => {
...
//   const stopListenIsInteract = () => {
//     document.removeEventListener(
//       device.getInteractEventName(),
//       this._onIsInteract
//     );
//   };

//   const stopListenStartInteract = (el) => {
//     el.removeEventListener(device.getStartEventName(), this._onStartInteract);
//   };

//   const stopListenStopInteract = (el) => {
//     device
//       .getStopEventNames()
//       .forEach((eventName) =>
//         el.removeEventListener(eventName, this._onStopInteract)
//       );
//   };

//   const removeHandlers = () => {
//     const el = regionContent.firstChild;
...
//   const onStopInteract = (e, resolve, reject) => {
//     offInteract();
//     model.erasePrevX();
...
//   const bindHandlers = () => {
//     addHandlers = addHandlers.bind();
//     isInteract = isInteract.bind();
//     interact = interact.bind();
//     onMove = onMove.bind();
//     stopInteract = stopInteract.bind();
//     offInteract = offInteract.bind();
//     endInteract = endInteract.bind();
//     onDelete = onDelete.bind();
...
//         model.startX = device.getPageX(e);
//         model.startY = device.getPageY(e);
//         resolve();
//       };

//       el.addEventListener(
//         this.device.getStartEventName(),
//         this._onStartInteract,
//         false
//       );
//     });
//   };

//   const getSwipePercent = () => {
//     const shift = regionContent.firstChild.offsetLeft;
//     const width = regionContent.clientWidth;

//     return model.calcSwipePercent({ shift, width });
//   };
...
//         stopListenIsInteract();
//         const wayX = device.getPageX(e) - model.startX;
//         const wayY = device.getPageY(e) - model.startY;
...
//   interact = () => {
//     document.addEventListener(device.getInteractEventName(), onMove, false);
//   };

//   offInteract = () => {
//     document.removeEventListener(device.getInteractEventName(), onMove, false);
//   };
...
//   endInteract = () => {
//     const el = regionContent.firstChild;
//     const swipePercent = getSwipePercent();
...
//       if (model.isDelete(swipePercent)) {
//         el.addEventListener(
//           'transitionend',
//           this._onTransitionendDelete,
//           false
//         );
//         swipePercent < 0
//           ? el.classList.add('js-transition-delete-left')
//           : el.classList.add('js-transition-delete-right');
//       } else {
//         el.addEventListener(
//           'transitionend',
//           this._onTransitionendCancel,
//           false
//         );
...
//     model.startX = model.startY = target.style.left = 0;
//   };

//   useEffect(() => {
//     bindHandlers();
//     device = Device.factory(isMobile.any());
//   }, []);
...
//     props.tag,
//     { className: `swipe-to-delete ${props.classNameTag}` },
//     [
...
//         ref={(el) => (regionContent = el)} // useRef maybe
//       >
//         {props.children}
//       </div>,
//     ]
...
export default class SwipeToDelete extends React.Component {
  ...
  get customProps() {
    ...
    const customProps = Object.keys(this.props).filter(
      (name) => !props.includes(name)
    );
